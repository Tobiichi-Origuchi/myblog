...
```
假设这个网页运行在 `http://114514.homo`，我只要构建一个这样的 url：`http://114514.homo#<img src=null onerrer="alert('114514')">`，并且诱导用户点击这个 url，网站就会赫然发出“114514”的很臭的警报，那很严重了
...
```
这样，Page Function 执行的时候就会自动把你的 png 图片和 css 样式文件排除在外
